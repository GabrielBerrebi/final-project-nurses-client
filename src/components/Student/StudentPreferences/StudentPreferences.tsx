        ...
        return (
            <Card title='Family' style={{flex: 1}}>
                <Form name='family' form={form} labelCol={{span: 12}} wrapperCol={{span: 12}} labelWrap
                    ...
                    <Form.Item label='Are you married?' name='married' valuePropName='checked'
                               rules={[{required: true}]}>
                        <Switch defaultChecked={false} onChange={(value: boolean) => setShowChildren(!value)}/>
                    </Form.Item>
                    <Space/>
                    <Form.Item label='How many children have you?' name='children' hidden={showChildren}>
                        <Select>
        ...
        return (
            <Card title='Work' style={{flex: 2}}>
                ...
                <Form name='family' form={form} labelCol={{span: 15}} labelWrap
                      ...
                      onFinish={(e) => console.log(e)} disabled={formsDisabled}>
                    <div>
                        <Form.Item label='Which days would you like to work?' name='desiredDays'>
                        ...
                        <Space/>
                        <Form.Item label='Which hours would you like to work?' name='desiredHours'>
                            <Select style={{width: 250}}>
                        ...
                        <Space/>
                        <Form.Item label='In which city would you like to work?' name='desiredCity'>
                            <Select style={{width: 250}}>
                    ...
                    <div>
                        <Form.Item label='Do you work?' name='work' valuePropName='checked'>
                            <Switch/>
                        </Form.Item>
                        <Space/>
                        <Form.Item label='Do you have a car?' name='car' valuePropName='checked'>
                            <Switch/>
                        </Form.Item>
                        <Space/>
